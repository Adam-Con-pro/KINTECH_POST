/**
  ...
  V1. Org Version 43964

  V2. Added Pass through ADC 12-12

  V3. Added Username and Date ADC 12-13

  V4. Removed probe rotate on 9832 and rotate off 9833 ADC 1-1-2024

  V5. Added Option of forcing Y axis Home at the end of program Adc 1-11-2024

  V6. Added G90 prior to postioning to start programs in process. 11-4-24
...
description = "KT - Mazak Mill 4TH Axis";
vendor = "Mazak";
...
longDescription = "KINTECH milling post for Mazak with a rotary table.";
...
function onOpen() {
  ...
  // V3. ADDED USER NAME AND DATE ADC 12-12
...
function onSection() {
  ...
  var spindleChanged = tool.type != TOOL_PROBE && !isInspectionOperation(currentSection) &&
  ...
  if (spindleChanged) {
    ...
    writeBlock(gFormat.format(90)); // Added ADC 11-4-24
  ...
  // V4. Removed 9832 rotate  Adc 1-11-2024
...
// V2. Insert Pass through ADC 12-12-23
...
function onSectionEnd() {
  ...
  //Removed 9833 rotate off Adc 1-11-2024
 /* if (isProbeOperation()) {
...
function onClose() {
  ...
  // V5. Added Force Y home Adc 1-11-2024
  {
